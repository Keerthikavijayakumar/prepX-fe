...
import { Users, Mail, User, Lock, Briefcase } from "lucide-react";
  ...
  return (
    <Card className="border-secondary/10 shadow-lg transition-all hover:shadow-secondary/5">
      <CardHeader className="space-y-1 pb-8">
        ...
        <CardTitle className="text-center text-3xl font-bold">Create Candidate Account</CardTitle>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter className="flex flex-col space-y-4 px-6 pb-8 pt-2">
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/candidate/login" className="text-secondary hover:underline font-medium transition-colors">
              Sign in
            </Link>
          </div>
        </CardFooter>
